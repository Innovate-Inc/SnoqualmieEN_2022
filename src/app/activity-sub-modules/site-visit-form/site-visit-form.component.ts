...
export class SiteVisitFormComponent implements OnInit {
  ...
  activityForm = new FormGroup({
    ...
    Site_Notes: new FormControl(),
    Site_Doc_Note: new FormControl(),
  ...
  constructor(public dialog: MatDialog, public snackBar: MatSnackBar, 
    ...
    public dialogRef: MatDialogRef<SiteVisitFormComponent>) {
  ...
  async save(): Promise<void> {
    ...
    if(this.activityForm.valid){
      ...
      if (this.isNew) {
        ...
        this.data.activityTask.attributes.Activity_Type = "sitevisit";
