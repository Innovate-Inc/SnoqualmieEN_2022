...
def main():
    try:
        #environment.reportService.surveyItem,
        ...
        print(token)
        #environment.reportService.surveyTemplate,
        ...
        portal_url = arcpy.GetParameter(6) #"https://maps.snoqualmietribe.us/portal"
        cliend_id = arcpy.GetParameter(7) #kdUmjgmiOPWq3Mpe
